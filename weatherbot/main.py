...
def send_welcome(message):
    bot.reply_to(message, f' Приятно познакомиться,{message.from_user.first_name}.Я бот, который показывает погоду. Погоду в каком горде вы хотите узнать? Пожалуйста, пишите название города на английском языке и не допускайте ошибок, иначе всё перестанет работать=)')
